...
$query = "select * from s1_book_toc where book_id=$book_id and type='$type' order by slno";
...
$query_aux = "select * from s1_books_list where book_id=$book_id and type='s1'";
...
$query_aux1 = "select * from s1_books_list where level='1' and slno < '$slno' order by slno desc limit 1";
...
?>
		<div id="contentWrapper">
			<div class="page_title"><span class="s1_motif"></span><h2><?php echo $book_title; ?></h2><a target="_blank" href="<?php echo "../../Volumes/$type/$book_id/index.djvu?djvuopts&amp;page=1&amp;zoom=page"?>" title="Read the book"><?php if(file_exists("../covers/s1/".$book_id."_l.jpg")){echo "<img src=\"../covers/s1/".$book_id."_l.jpg\" alt=\"\" />";}?></a></div>
