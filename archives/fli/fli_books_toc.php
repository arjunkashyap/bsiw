...
?>
		<div id="contentWrapper">
			<div class="page_title"><span class="fli_motif"></span><h2><?php echo $book_title; ?></h2><a target="_blank" href="<?php echo "../../Volumes/$type/$book_id/index.djvu?djvuopts&amp;page=1&amp;zoom=page"?>" title="Read the book"><?php if(file_exists("../covers/fli/".$book_id."_l.jpg")){echo "<img src=\"../covers/fli/".$book_id."_l.jpg\" alt=\"\" />";}?></a></div>
