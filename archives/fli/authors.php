...
<?php include('header.php'); ?>
	<div class="mainpage">
		...
		<div id="contentWrapper">
			<div class="page_title"><span class="fli_motif"></span><h2>Authors <span class="it">(Flora of India)</span></h2></div>
			<div class="alphabet">
...
{
	echo "<li>Sorry! No author names were found to begin with the letter '$letter' in Flora of India</li>";
}
