...
<?php include('header.php'); ?>
	<div class="mainpage">
		...
		<div id="contentWrapper">
			<div class="page_title"><span class="rec_motif"></span><h2>Authors <span class="it">(Records)</span></h2></div>
			<div class="alphabet">
...
{
	echo "<li>Sorry! No author names were found to begin with the letter '$letter' in Records</li>";
}
$result->free();
$db->close();
?>
