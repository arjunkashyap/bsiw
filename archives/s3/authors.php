...
<?php include('header.php'); ?>
	<div class="mainpage">
		...
		<div id="contentWrapper">
			<div class="page_title"><span class="s3_motif"></span><h2>Authors <span class="it">(District Flora - Series 3)</span></h2></div>
			<div class="alphabet">
...
{
	echo "<li>Sorry! No author names were found to begin with the letter '$letter' in District Flora (Series 3)</li>";
}
