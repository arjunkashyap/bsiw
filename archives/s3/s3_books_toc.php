...
?>
		<div id="contentWrapper">
			<div class="page_title"><span class="s3_motif"></span><h2><?php echo $book_title; ?></h2><a target="_blank" href="<?php echo "../../Volumes/$type/$book_id/index.djvu?djvuopts&amp;page=1&amp;zoom=page"?>" title="Read the book"><img src="../covers/s3/<?php echo $book_id; ?>_l.jpg" alt="" style="float:right;margin-top:-20px;margin-right:10px" /></a></div>
...
if($num_rows)
{
	...
	for($i=1;$i<=$num_rows;$i++)
	{
		...
		{
			$title = "<span class=\"featurespan\"><a href=\"s3_si.php?book_id=$book_id&amp;type=$type&amp;book_title=$book_title\">$title</a></span>";
		}
		else
		{
			if($page == '')
