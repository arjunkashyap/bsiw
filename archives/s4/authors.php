...
<?php include('header.php'); ?>
	<div class="mainpage">
		...
		<div id="contentWrapper">
			<div class="page_title"><span class="s4_motif"></span><h2>Authors <span class="it">(Miscellaneous - Series 4)</span></h2></div>
			<div class="alphabet">
...
{
	echo "<li>Sorry! No author names were found to begin with the letter '$letter' in Miscellaneous Publications (Series 4)</li>";
}
