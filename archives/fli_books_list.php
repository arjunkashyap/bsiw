...
<?php include('header.php'); ?>
	<div class="mainpage">
		...
		<div id="contentWrapper">
			...
			<div class="page_title"><span class="fli_motif"></span><h2>Flora of India</h2></div>
...
$query = "select * from fli_books_list order by slno";
...
<?php while($row = mysql_fetch_assoc($result)){ ?>
	...
	<li>
		<div class="bookImg">
			<a href="fli/fli_books_toc.php?book_id=<?php echo $row['book_id']; ?>&amp;type=fli&amp;book_title=<?php echo urlencode($row['title']); ?>" ><img src="covers/fli/<?php echo $row['book_id']; ?>_s.jpg" alt="" /></a>
		</div>
		<div class="bookDets">
			<div class="bookTitle"><a href="fli/fli_books_toc.php?book_id=<?php echo $row['book_id']; ?>&amp;type=fli&amp;book_title=<?php echo urlencode($row['title']); ?>" ><?php echo $row['title']; ?></a></div>
