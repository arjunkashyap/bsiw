...
?>
		<div id="contentWrapper">
			<div class="page_title"><span class="vnv_motif"></span><h2><?php echo $book_title; ?></h2><a target="_blank" href="<?php echo "../../Volumes/$type/$book_id/index.djvu?djvuopts&amp;page=1&amp;zoom=page"?>" title="Read the book"><img src="../covers/vnv/<?php echo $book_id; ?>_l.jpg" alt="" /></a></div>
